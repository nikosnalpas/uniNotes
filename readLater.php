...
<body>
  ...
  if(isset($_POST['btn'])){
    ...
    $stmt->execute();
           ...
           if(is_null($idClass)){
            ...
            if($idClass==0){ 
               $result = $mysqli->query("SELECT * FROM notes, user_has_readLater WHERE user_has_readLater.users_idusers = '$idUser' AND user_has_readLater.notes_idnotes = notes.idNotes ORDER BY addedAt DESC");
            }else{
               $result = $mysqli->query("SELECT * FROM notes, user_has_readLater WHERE user_has_readLater.users_idusers = '$idUser' AND user_has_readLater.notes_idnotes = notes.idNotes AND Classes_idClasses = $idClass ORDER BY addedAt DESC");
            }   
  ...
  <div class = "mainMessages_container">
    <?php
...
<div id="top-wrapper">
      ...
      <div class = "locationButtons">        
        <div class = "mainPageButtonWrapper">
          <label class = "mainPageLabel" onclick = "mainPage()">main page</label>
        </div>
        <div class = "readLaterButtonWrapper active">
  ...
  <form method="post" enctype="multipart/form-data" id="upload-wrapper">  
    ...
    <?php
      if($_SESSION['profPic']=='0'){
       ...
       ?>
    <textarea maxlength="100" placeholder="Describe the photo." name = "textAbout" id="textAbout"></textarea>
